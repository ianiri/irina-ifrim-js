var person = {
  ...
  age: 32,
  petOwner: false,
  skills: ['html', 'css', 'sass', 'bootstrap', 'npm', 'git', 'vscode'],
  friends: [
    {
      name: 'Larry',
      surname: 'Larryson',
...
console.log(`Ma numesc ${person.name} ${person.surname} si vreau sa invat ${person.skills[6]}.`);
